import type { PresentationOptionsData } from "../../type/content-blocks";

export const PresentationOptions: React.FC<PresentationOptionsData> = ({ presentation_options }) => {
return (
<div>
<h2 className={`text-lg font-bold mb-2`}>Presentation Options & Respective Materials</h2>
<ul>
{presentation_options.option.map((option) => {
return (
